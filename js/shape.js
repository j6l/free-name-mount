...
;(function (global, factory) {
    ...
    function setViewBox(container, _a) {
        ...
        if (container && hasClass(container, CLASS_NAME)) {
            ...
            var _b = (container.getAttribute('viewBox') || '')
                    .split(' ')
                    .map(function (pos) {
            ...
            container.setAttribute(
                'viewBox',
                '0 0 ' + // tslint:disable-next-line:max-line-length
                (Math.max(left + width + right + strokeWidth, boxWidth) +
                    ' ' +
                    Math.max(top + height + bottom + strokeWidth, boxHeight))
            )
        }
    }
    ...
    function getRect(_a) {
        ...
        var startRad =
            (Math.PI / 180) * rotate + Math.PI * ((side % 2 ? 0 : 1 / side) - 1 / 2)
        ...
        var diagonal =
            ...
            (sideCos === innerCos
                ? 1
                : Math.sin(Math.atan(sideSin / (sideCos - innerCos))))
